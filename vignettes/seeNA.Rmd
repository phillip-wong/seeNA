...
The other function, `seeNA` takes a data frame with missing values and plots a proportion of missing values per column in a data set. It allows for easy 
visualizations to understand exactly how missing values are impacting your data set. The example is below:
